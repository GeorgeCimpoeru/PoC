...
/**
 * @param byteVector vector in which the values are inserted
 * @param num number that will be split and inserted in the vector
 * @param numBytes number of bytes that will be inserted
 */
